...
public class EditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri currentPetUri = fromCatalogActivity.getData();
    ...
    public void insertPetRecord() {
        String[] petInfo = new String[3];
        petInfo[0] = mNameEditText.getText().toString();
        petInfo[1] = mBreedEditText.getText().toString();
        petInfo[2] = mWeightEditText.getText().toString();
